...
/*
	...
	output: a cube rotated and in a diferent place and with a texture applied
*/
...
OBJLoader object("../models/monkey.obj");
...
void init(void) 
{
	...
	*/
	...
	baseTextureId = loadTexture("../models/textures/texture_door.jpg");
